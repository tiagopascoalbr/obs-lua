...
function script_properties()
	...
	local p_33 = obs.obs_properties_add_path( props, "backup_folder", "Pasta de backup", obs.OBS_PATH_DIRECTORY, nil, nil)
	local p_34 = obs.obs_properties_add_list( props, "import_list", "<i>Carregar configurações</i>", obs.OBS_COMBO_TYPE_LIST, obs.OBS_COMBO_FORMAT_STRING )
